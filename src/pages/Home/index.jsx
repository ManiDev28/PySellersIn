...
const Home = () => {
  /**
   * Below is the section to update our offered servives
   */
  const services = [
    {
      id: 1,
      ...
      description:
        'We provide application development services driven by the enthusiasm of young minds.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        'Our developers specialize in automation and open-source frameworks to reduce licensing costs.',
    },
  ];

  /**
   * Core team members name list
   */
  const teamMembers = [
    {
      id: 1,
      image: '/images/HomePage/founder_photo.png',
    ...
    <div className="bg-global-3 flex flex-col items-center w-full">
      ...
      <main className="flex flex-col gap-8 sm:gap-12 lg:gap-[48px] items-center w-full mt-4 sm:mt-6 lg:mt-[20px] mx-4 sm:mx-6 lg:mx-[26px]">
        ...
        <section className="w-full">
          {/*
          changed w-100% h-auto bg-contain for image to be fully contained
           */}
          <div className=" bg-[url('/images/HomePage/banner-img.png')] bg-contain bg-center rounded-lg p-4 sm:p-6 lg:p-[28px] w-100% h-auto sm:h-[400px] lg:h-[500px] flex items-center justify-center">
            <div className="flex flex-col lg:flex-row items-center justify-between w-full">
              <div className="flex flex-col items-start w-full lg:w-[44%] mb-6 lg:mb-0 lg:mt-[118px]">
                ...
                <p className="text-white font-ibm-plex font-medium text-sm sm:text-base lg:text-[18px] leading-5 sm:leading-6 lg:leading-[23px] w-full lg:w-[94%] mb-6 sm:mb-8 lg:mb-[46px]">
                  Transform your business with cutting-edge technology solutions designed to drive
        ...
        <section className="flex flex-col items-center w-full px-4 sm:px-6 lg:px-[56px]">
          <div className="flex flex-col gap-4 sm:gap-5 lg:gap-[20px] items-center w-full lg:w-[44%] mb-8 sm:mb-12 lg:mb-[94px]">
            ...
            <p className="text-global-1 font-inter font-medium text-xs sm:text-sm lg:text-[14px] leading-4 sm:leading-5 lg:leading-[16px] text-center">
              Welcome to PYSELLERS SERVICES PRIVATE LIMITED, an IT Software Company PYSELLERS has
              been in the software business in India since 2024
              <br />
              We have extensive industry experience What makes PYSELLERS unique is our ability to
              help clients tackle their challenges.
            </p>
          </div>
          ...
          <p className="text-global-1 font-ibm-plex font-medium text-sm sm:text-base lg:text-[17px] leading-5 sm:leading-6 lg:leading-[22px] text-center w-full">
            PySellers Services (OPC) Private Limited is a next-generation technology and consulting
            company focused on delivering AI-powered business solutions, automation tools, and
            cloud-based innovations. We specialize in transforming business needs into scalable,
            intelligent products using AI, Data Science, and Full-Stack Development.
          </p>
        </section>
        ...
        <section className="w-full">
          <div className="bg-global-2 px-4 sm:px-6 lg:px-[52px] py-8 sm:py-12 lg:py-[60px] flex flex-col gap-6 sm:gap-8 lg:gap-[42px] items-center w-full">
            ...
            {/*Below can be used to map the person-image/role to the grid*/}
