...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#e6f0fa] to-[#ffffff]">
      ...
      {/* Hero Section */}
      <section 
  className="relative w-full bg-cover bg-no-repeat mt-5"
  style={{ 
    backgroundImage: "url('/images/AboutUs/banner-img.png')", 
    backgroundPosition: 'center 40%' 
  }}
>
  <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-14 py-24 sm:py-32 lg:py-[148px]">
    <div className="flex flex-col gap-6 sm:gap-8 lg:gap-8 mt-16 sm:mt-20 lg:mt-[106px] ml-0 sm:ml-4 lg:ml-[36px]">
      ...
      <h1 className="text-2xl sm:text-3xl lg:text-[38px] font-medium font-ibm-plex text-global-2 leading-8 sm:leading-10 lg:leading-[49px] w-full lg:w-[80%]">
      ...
      <section className="w-full max-w-[1388px] mx-auto px-4 sm:px-6 lg:px-14 py-12 sm:py-16 lg:py-0 mt-8 sm:mt-12 lg:mt-[104px]">
        <div className="flex flex-col gap-16 sm:gap-20 lg:gap-[130px]">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-start gap-8 lg:gap-[98px] w-full lg:w-[90%] mx-auto">
            ...
            {/* Vision Card */}
            <div className="flex flex-col gap-4 lg:gap-5 justify-start items-start w-full lg:w-[550px] bg-global-3 border border-[#bcbcbc] rounded-[14px] p-4 sm:p-6 lg:p-[10px_12px_10px_12px]">
              <div className="bg-global-2 rounded-[5px] p-3 ml-0 lg:ml-[6px] mt-0 lg:mt-[5px]">
                <img 
