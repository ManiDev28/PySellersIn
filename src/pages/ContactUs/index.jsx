...
<div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-[100px] w-full max-w-[1100px] mx-auto mb-16">
  {/* Our Address */}
  <div className="flex flex-col justify-start items-center w-full lg:w-[202px] mt-8 lg:mt-[0.7cm]">
  ...
  {/* Email Address */}
  <div className="flex flex-col justify-start items-center w-full lg:w-[268px]">
    <div className="flex justify-center items-center w-20 h-20 bg-global-1 rounded-full mb-4">
      <img 
